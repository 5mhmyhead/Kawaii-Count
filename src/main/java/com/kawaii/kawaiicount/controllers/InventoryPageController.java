...
public class InventoryPageController
{
    ...
    private void initialize()
    {
        ...
        List<SidebarItem> targets = List.of(
            new SidebarItem(menuButton, menuWhite, "menu-page", 400, 60),
            new SidebarItem(ordersButton, ordersWhite, "orders-page", 450, 120),
            new SidebarItem(analyticsButton, analyticsWhite, "analytics-page", 500, 180),
            new SidebarItem(settingsButton, settingsWhite, "settings-page", 550, 425),
            new SidebarItem(signOutButton, signOutWhite, "title-page", 600, 485)
        );
