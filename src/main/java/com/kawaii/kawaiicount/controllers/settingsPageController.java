...
{
    @FXML
    private AnchorPane selectionIndicator;
    ...
    private void initialize()
    {
        ...
        List<SidebarItem> targets = List.of(
                ...
                new SidebarItem(menuButton, menuWhite, "menu-page", 450, -365),
                new SidebarItem(ordersButton, ordersWhite, "orders-page", 400, -305),
                new SidebarItem(analyticsButton, analyticsWhite, "analytics-page", 350, -245),
