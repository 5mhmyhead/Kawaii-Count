...
public class menuPageController
{
    ...
    private void initialize()
    {
        ...
        List<SidebarItem> targets = List.of(
                ...
                new SidebarItem(ordersButton, ordersWhite, "orders-page", 350, 60),
                new SidebarItem(analyticsButton, analyticsWhite, "analytics-page", 400, 120),
                new SidebarItem(settingsButton, settingsWhite, "settings-page", 450, 365),
