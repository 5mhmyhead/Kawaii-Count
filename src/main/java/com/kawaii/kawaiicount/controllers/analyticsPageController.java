...
public class analyticsPageController
{
    ...
    private void initialize()
    {
        ...
        List<SidebarItem> targets = List.of(
                ...
                new SidebarItem(menuButton, menuWhite, "menu-page", 350, -120),
                new SidebarItem(ordersButton, ordersWhite, "orders-page", 400, -60),
                new SidebarItem(settingsButton, settingsWhite, "settings-page", 450, 245),
